...
unsigned long MelodyToSound::getDuration(unsigned long base_duration, unsigned int numerator, unsigned int denominator)
{
    if (denominator == 0)
    {
        return 0;
...
unsigned int MelodyToSound::getFrequency(int index)
{
